...
const BL = {
  ...
  GLOWSTONE: 30, BOOKSHELF: 31, PUMPKIN: 32,
};
...
defBlock(BL.GRASS, { name: 'Grass Block', tiles: { top: TILE.GRASS_TOP, bottom: TILE.DIRT, side: TILE.GRASS_SIDE }, hardness: 0.9, drop: BL.DIRT });
defBlock(BL.DIRT, { name: 'Dirt', tiles: { all: TILE.DIRT }, hardness: 0.75 });
defBlock(BL.STONE, { name: 'Stone', tiles: { all: TILE.STONE }, hardness: 2.2, drop: BL.COBBLE });
defBlock(BL.COBBLE, { name: 'Cobblestone', tiles: { all: TILE.COBBLE }, hardness: 2.5 });
defBlock(BL.BEDROCK, { name: 'Bedrock', tiles: { all: TILE.BEDROCK }, hardness: -1 });
defBlock(BL.SAND, { name: 'Sand', tiles: { all: TILE.SAND }, hardness: 0.75 });
defBlock(BL.SANDSTONE, { name: 'Sandstone', tiles: { top: TILE.SANDSTONE_TOP, bottom: TILE.SANDSTONE_TOP, side: TILE.SANDSTONE_SIDE }, hardness: 1.8 });
defBlock(BL.LOG, { name: 'Oak Log', tiles: { top: TILE.LOG_TOP, bottom: TILE.LOG_TOP, side: TILE.LOG_SIDE }, hardness: 2.0 });
defBlock(BL.PLANKS, { name: 'Oak Planks', tiles: { all: TILE.PLANKS }, hardness: 2.0 });
defBlock(BL.LEAVES, { name: 'Leaves', tiles: { all: TILE.LEAVES }, opaque: false, cutout: true, hardness: 0.3 });
defBlock(BL.GLASS, { name: 'Glass', tiles: { all: TILE.GLASS }, opaque: false, cutout: true, hardness: 0.4, drop: 0 });
defBlock(BL.BRICK, { name: 'Bricks', tiles: { all: TILE.BRICK }, hardness: 2.5 });
defBlock(BL.SNOW, { name: 'Snowy Grass', tiles: { top: TILE.SNOW_TOP, bottom: TILE.DIRT, side: TILE.SNOW_SIDE }, hardness: 0.9, drop: BL.DIRT });
defBlock(BL.WATER, { name: 'Water', tiles: { all: TILE.WATER }, solid: false, opaque: false, fluid: true, hardness: -1 });
defBlock(BL.CACTUS, { name: 'Cactus', tiles: { top: TILE.CACTUS_TOP, bottom: TILE.CACTUS_TOP, side: TILE.CACTUS_SIDE }, opaque: false, hardness: 0.6 });
defBlock(BL.COAL_ORE, { name: 'Coal Ore', tiles: { all: TILE.COAL_ORE }, hardness: 3.0 });
defBlock(BL.IRON_ORE, { name: 'Iron Ore', tiles: { all: TILE.IRON_ORE }, hardness: 3.5 });
defBlock(BL.GOLD_ORE, { name: 'Gold Ore', tiles: { all: TILE.GOLD_ORE }, hardness: 3.5 });
defBlock(BL.DIAMOND_ORE, { name: 'Diamond Ore', tiles: { all: TILE.DIAMOND_ORE }, hardness: 4.0 });
defBlock(BL.GRAVEL, { name: 'Gravel', tiles: { all: TILE.GRAVEL }, hardness: 0.8 });
...
defBlock(BL.FLOWER_RED, { name: 'Rose', tiles: { all: TILE.FLOWER_RED }, solid: false, opaque: false, cross: true, cutout: true, hardness: 0.05 });
defBlock(BL.FLOWER_YELLOW, { name: 'Dandelion', tiles: { all: TILE.FLOWER_YELLOW }, solid: false, opaque: false, cross: true, cutout: true, hardness: 0.05 });
defBlock(BL.TALLGRASS, { name: 'Tall Grass', tiles: { all: TILE.TALLGRASS }, solid: false, opaque: false, cross: true, cutout: true, hardness: 0.05, drop: 0 });
defBlock(BL.GLOWSTONE, { name: 'Glowstone', tiles: { all: TILE.GLOWSTONE }, hardness: 0.6 });
defBlock(BL.BOOKSHELF, { name: 'Bookshelf', tiles: { top: TILE.PLANKS, bottom: TILE.PLANKS, side: TILE.BOOKSHELF }, hardness: 1.8 });
defBlock(BL.PUMPKIN, { name: 'Pumpkin', tiles: { top: TILE.PUMPKIN_TOP, bottom: TILE.PUMPKIN_TOP, side: TILE.PUMPKIN_SIDE }, hardness: 1.2 });
